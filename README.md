...
提供**危险操作拦截**、**代码规范与提交管控**、**子智能体行为约束**三大能力，内置 3 个子智能体和 11 个 skill。
...
### 📚 内置 skill（11 个）
mysql-expert、robust-architecture、chinese-commit-messages、docker-expert、code-reuse-audit、root-cause-no-patch、frontend-dashboard-layout-spec、pyinstaller-packaging、maxscript-pitfalls、plugin-creator、using-wakita
