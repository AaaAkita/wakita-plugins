...
提供**危险操作拦截**、**代码规范与提交管控**、**子智能体行为约束**三大能力，内置 4 个子智能体和 14 个 skill。
...
### 🤖 内置子智能体（4 个）
- `code-explorer` — 代码库探索专家（只读）
- `code-reviewer` — 代码审查员
- `code-writer` — 代码执行专家
- `cheap-programmers` — 经济型编程助手

### 📚 内置 skill（14 个）
chinese-commit-messages、docker-expert、code-reuse-audit、root-cause-no-patch、avoid-assumption-loops、frontend-docker-dev、frontend-dashboard-layout-spec、automatic-script-tool-build、imagegen、maxscript-pitfalls、openai-docs、plugin-creator、skill-creator、skill-installer
