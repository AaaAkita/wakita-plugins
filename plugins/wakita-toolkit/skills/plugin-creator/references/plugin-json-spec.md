...
- This repo’s scaffold writes `.claude-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how ZCode 渲染 plugins.
